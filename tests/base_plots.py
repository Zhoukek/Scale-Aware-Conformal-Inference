...
if __name__ == "__main__":
    ...
    logname = 'results/{}_cover.log'.format(dataset_name)
    # 配置日志
    logging.basicConfig(
        filename=logname,      
        level=logging.INFO,     
    ...
    method_title_map = {
        ...
        'full_smoothed_eci': 'fully smoothed method',
        'smoothed_ogd': 'smoothed method',
        'LQT': 'LQT',
        'COP': 'COP',
        'SACI': 'SACI'
    }
    ...
    for model_name in model_names:
        ...
        for key in results.keys():
            ...
            for lr in results[key].keys():
                ...
                logging.info("Method: {key} with {label}".format(key=key, label=label))
                # pdb.set_trace()
